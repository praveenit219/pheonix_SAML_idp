...
@Controller
public class SsoControllerPost {
	...
	@GetMapping(path = "/SingleSignOnServicePost/alias/pheonix/idp")
	public void singleSignOnServiceGet(HttpServletRequest request, HttpServletResponse response, Authentication authentication)
		...
		System.out.println("/SingleSignOnServicePost/alias/pheonix/idp get--------------");
	...
	@PostMapping(path = "/SingleSignOnServicePost/alias/pheonix/idp")
	public void singleSignOnServicePost(HttpServletRequest request, HttpServletResponse response, Authentication authentication)
		...
		System.out.println("/SingleSignOnServicePost/alias/pheonix/idp post--------------");
		doSSOForArtifactResolveRequest(request, response, authentication, true,false);
		
	}

	@SuppressWarnings("unchecked")
	private void doSSOForArtifactResolveRequest(HttpServletRequest request, HttpServletResponse response, Authentication authentication, boolean postRequest,boolean soapRequet) throws ValidationException, SecurityException, MessageDecodingException, MarshallingException, SignatureException, MessageEncodingException, MetadataProviderException, IOException, ServletException {
		SAMLMessageContext messageContext = samlMessageHandler.extractSAMLMessageContext(request, response, postRequest,soapRequet);
